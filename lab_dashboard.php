...
$cleared = mysqli_fetch_assoc(mysqli_query($conn,"SELECT COUNT(*) c FROM dues WHERE lab_due=0"))['c'];
$pending = mysqli_fetch_assoc(mysqli_query($conn,"SELECT COUNT(*) c FROM dues WHERE lab_due>0"))['c'];
...
<head>
    ...
    <title>Lab Dashboard | SCOE Digital System</title>
...
<div class="navbar">
    ...
    <div class="nav-links" id="navMenu">
        ...
        <a href="lab_dashboard.php" class="active">Dashboard</a>
...
<div class="container">
    ...
    <div class="dashboard-header">
        <div class="page-title">Lab Dashboard</div>
    ...
    <div class="grid">
        ...
        <div class="card">
            <div class="card-label">Cleared (Lab)</div>
    ...
    <!-- TABLE: pending lab dues (lab_due > 0) -->
    <div class="table-card">
        <h3> Pending Lab Dues</h3>
        <table>
            <thead>
                <tr>
                    <th>Name</th>
            ...
            <tbody>
                <?php if (mysqli_num_rows($result) > 0): ?>
                    <?php while ($row = mysqli_fetch_assoc($result)): ?>
                        <tr>
                            ...
                            <td>₹<?= number_format($row['lab_due']) ?></td>
                            <td>
                                <?php if ($row['lab_due'] > 0): ?>
                                    <a href="delete_due.php?id=<?= $row['student_id'] ?>&type=lab" class="btn btn-pending">Pending</a>
                                <?php else: ?>
                ...
                <?php else: ?>
                    <tr class="empty-row">
                        <td colspan="4">No pending lab dues found.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
